...
export default function TermosUso() {
  return (
    <Container className="my-5">
      ...
      <p>Bem-vindo à <strong>Loja Acadêmica IA</strong>. Ao acessar e utilizar nosso site, você concorda com os seguintes termos e condições:</p>
      ...
      <p>Todo o conteúdo deste site, incluindo imagens, textos, logotipos e ilustrações, é de propriedade exclusiva da Loja Acadêmica IA. É proibida a reprodução sem autorização prévia.</p>

      <h5 className="mt-4">4. Compras e Pagamentos</h5>
      <p>As compras realizadas na Loja Acadêmica IA são intermediadas por plataformas seguras como gateway de pagamento fictício. O cliente se compromete a fornecer dados corretos e completos durante o processo.</p>
